...
namespace Drupal\Tests\marvin_phplint_incubator\Helper;
...
class ComposerScripts {
  ...
  protected function prepareProjectComposerJson() {
    $content = [
      'name' => 'drupal/marvin-phplint-incubator-tests-project_01',
      'description' => 'drupal/marvin-phplint-incubator-tests-project_01',
      "license" => "proprietary",
      'type' => 'drupal-project',
      'extra' => [
        'installer-types' => [
...
TEXT;
  ...
  protected function getProjectSelfFilesToSymlink(): array {
    ...
    $filesToSymLink = $extra['marvin_phplint_incubator']['fixtures']['filesToSymlink'] ?? [];
